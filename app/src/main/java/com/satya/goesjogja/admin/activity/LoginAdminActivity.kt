...
import com.satya.goesjogja.user.activity.ForgotPasswordActivity
import com.satya.goesjogja.user.activity.HomeActivity
...
class LoginAdminActivity : BaseActivity(), View.OnClickListener {
        ...
        if(v != null){
            when(v.id){
                ...
                R.id.tv_forgot_password -> {
                    val intent = Intent(this@LoginAdminActivity, ForgotPasswordActivity::class.java)
                    startActivity(intent)
                }
            }
        }
